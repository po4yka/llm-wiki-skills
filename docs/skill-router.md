...
| [`llm-wiki-capture-pipeline`](../skills/llm-wiki-capture-pipeline/SKILL.md) | capture pipeline architecture; cross channel topology; inbox raw flow; capture metadata contract; dedupe boundary; triage handoff; telegram connector; email connector; voice note connector; slack export runbook; specific channel connector; channel api setup |  | low | no | design-proposal | wiki-triage, llm-wiki-ingestion-stack |
