...
| [`llm-wiki-benchmark-suite`](../skills/llm-wiki-benchmark-suite/SKILL.md) | pilot benchmark; run baseline pass; run with wiki pass; score pilot tasks; continue pause redesign decision | define measurement; evaluate usefulness; eval framework selection; choose scorecard | low | no | report-only | llm-wiki-eval-tooling, llm-wiki-human-first-design, llm-wiki-critique-audit |
| [`llm-wiki-capture-pipeline`](../skills/llm-wiki-capture-pipeline/SKILL.md) | capture pipeline architecture; cross channel topology; inbox raw flow; capture metadata contract; dedupe boundary; triage handoff | telegram connector; email connector; slack export runbook; specific channel connector; channel api setup | low | no | design-proposal | llm-wiki-channel-capture, wiki-triage |
| [`llm-wiki-channel-capture`](../skills/llm-wiki-channel-capture/SKILL.md) | telegram connector; email connector; voice note connector; slack export runbook; specific channel connector; channel api setup | cross channel topology; capture metadata contract; dedupe boundary; triage handoff | low | yes | connector-design-proposal | wiki-triage, llm-wiki-ingestion-stack |
...
| [`llm-wiki-eval`](../skills/llm-wiki-eval/SKILL.md) | define measurement; evaluate usefulness; quality metrics; retrieval hit rate; maintenance health; interpret eval results | pilot benchmark; run baseline pass; run with wiki pass; eval tools; ci eval gates; eval framework selection | low | no | report-only | llm-wiki-benchmark-suite, llm-wiki-eval-tooling, llm-wiki-human-first-design, llm-wiki-critique-audit |
| [`llm-wiki-eval-tooling`](../skills/llm-wiki-eval-tooling/SKILL.md) | eval tools; ragas promptfoo deepeval; ci eval gates; choose scorecard; eval framework selection | pilot benchmark; run baseline pass; run with wiki pass; define measurement | none | yes | recommendation-with-citations | llm-wiki-benchmark-suite |
