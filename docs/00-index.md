...
10. [`07-skills-overview.md`](07-skills-overview.md)
...
### Fast path: human-first wiki design
...
12. [`09-references.md`](09-references.md)
13. [`domain-pack-schema.md`](domain-pack-schema.md)
14. [`technology-decision-record-template.md`](technology-decision-record-template.md)
15. [`release-policy.md`](release-policy.md)
...
11. [`security/skill-supply-chain.md`](security/skill-supply-chain.md)
12. [`security/ci-severity-policy.md`](security/ci-severity-policy.md)
13. [`security/redaction-policy.md`](security/redaction-policy.md)
14. [`provenance/claim-anchors.md`](provenance/claim-anchors.md)
...
| [`12-evidence-and-faq.md`](12-evidence-and-faq.md) | Evidence-backed FAQ for LLM-Wiki | arguments, comparative evidence and honest caveats for answering users who ask why LLM-Wiki matters, what benefits it provides, what evidence exists, how to keep a wiki alive and whether Obsidian is required. | 2026-07-06 |
...
| [`24-human-first-llm-wiki.md`](24-human-first-llm-wiki.md) | Human-first LLM-Wiki design | fix the adoption argument that LLM-Wiki must not be treated as an agent-generated document dump. The wiki must remain useful when agents are unavailable, while agents assist with bookkeeping, linking, linting and refresh. | 2026-07-07 |
...
| [`operations/refresh.md`](operations/refresh.md) | Operational refresh reports | deterministic offline refresh reports for stale source-backed claims and ecosystem registry entries. | 2026-07-07 |
...
The default target is a local-first, git-versioned vault, but non-developer users should be offered browser-first or capture-first surfaces. Heavy retrieval and graph infrastructure is treated as an upgrade path, not as day-one scaffolding. A useful wiki must remain human-findable and human-readable without agents; agent workflows should improve maintenance, not replace navigation and review.
