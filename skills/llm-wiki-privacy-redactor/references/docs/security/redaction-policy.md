...
![Diagram of private wiki content being redacted before safe export.](../assets/security-redaction.png)
...
```bash
node scripts/redact-preview.mjs examples/redaction-case
```
